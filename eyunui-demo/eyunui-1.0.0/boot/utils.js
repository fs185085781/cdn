    ...
    function loadMiniUi(miniui){
        var miniUtils = {
            setSkin:function(skin){
                ...
                var url = miniui.cssPath + '/skins/' + skin + '/skin.css';
                if(ele){
                    ele.href = url;
                }else{
        ...
        /*加载样式*/
        document.write('<link href="' + miniui.cssPath + '/miniui.css" rel="stylesheet" type="text/css" />');
        var ua = window.navigator.userAgent.toLowerCase();
        var isAndroid = ua && ua.indexOf("android") > 0;
        var isIOS = ua && /iphone|ipad|ipod|ios/.test(ua);
        var isMobile = isAndroid || isIOS;
        if(isMobile){
            document.write('<link href="' + miniui.cssPath + '/m.css" rel="stylesheet" type="text/css" />');
        }else{
            document.write('<link href="' + miniui.cssPath + '/pc.css" rel="stylesheet" type="text/css" />');
        }
    }
